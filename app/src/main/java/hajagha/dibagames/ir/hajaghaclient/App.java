...
public class App extends Application {
    ...
    public static String url = "http://151.80.214.76:8080/";
    ...
    public static String urlsignup = "signup?";
    public static String urlsetquestion = "setquestion?";
    public static String urlgetcomment = "comment?";
    public static String urlsetcomment = "setcomment?";
    public static String urlgetmyquestions = "myquestions?";
    ...
    public static String[] keysGetOneQuestion = {
            "id"
    };
    public static String[] keysSignup = {
            "username",
            "password",
            "email",
            "type"
    };
    public static String[] keysSetQuestion = {
            "userid",
            "title",
            "body"
    };
    public static String[] keysGetComment = {
            "questionid"
    };
    public static String[] keysSetComment = {
            "userid",
            "questionid",
            "comment"
    };
    public static String[] keysGetMyQuestions = {
            "userid"
    };
    ...
    public static void setDispalay(Display dispalay) {
        _display = dispalay;
    }
